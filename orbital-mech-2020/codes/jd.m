...
L_mars = mod (parameter_mars(1,1),360);%%%degree
a_mars = parameter_mars(2,1);
e_mars = parameter_mars(3,1);
i_mars = parameter_mars(4,1);
w_mars = parameter_mars(5,1);
W_mars = parameter_mars(6,1);
M_mars= L_mars-w_mars-W_mars;

%%%earth
i_earth=0;
a_earth=1.000002;%%%AU
%%L_earth=mod(99.69668 + 36000.76892*T + 0.0003025*T^2)*180/pi;%%%degree
e_earth=0.01675104-0.0000418*T-0.000000126*T^2;
%%M_earth=L_earth-pi;
